...
class appColors{
  static Color mainColor = Color(0xff5D9CEC);
  ...
  static Color darkBNB = Color(0xff141922);
  static Color fadedText = Color(0xffA9A9A9);
  static Color fadedTextborder = Color(0xff000000);
}